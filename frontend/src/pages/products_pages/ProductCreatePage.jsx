        ...
        <form action="#">
          <div className="user-details">
            <div className="input-box">
              ...
              {file ? (
              <img style={{width:200, height:150}}id="image" alt="Thumb" src={URL.createObjectURL(file)} 
              />) : (
                <img style={{width:200, height:150}}id="image" alt="Thumb" src="/image/carvector2.png" 
                />)}
          ...
          <div className="button">
              <button className="primary" type="submit" onClick={submitHandler}>  Create </button>
          </div>
            {loadingCreate && <LoadingBox></LoadingBox>}
        </form>
      </div>
